...
if (!empty($fck_user_files_path)) {
  ...
  $Config['UserFilesPath'] = strtr(base_path(), array(
    '/sites/all/modules/contributions/fckeditor/fckeditor/editor/filemanager/connectors/php' => '',
    '/sites/all/modules/contributions/fckeditor/fckeditor/editor/filemanager/browser/default/connectors/php' => '',
    '/sites/all/modules/contributions/fckeditor/fckeditor/editor/filemanager/upload/php' => '',
  )) . file_directory_path() .'/';
}
